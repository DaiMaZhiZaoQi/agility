...
role_tool = {
    ...
    init_main_view: function () {
        $("#role_grid").datagrid({
            ...
            onDblClickRow: function (index, row) {
                ...
                $("#role_edit_dialog").dialog("center");
            },
        });
    },
    delete: function () {
    ...
    save: function () {
        if (!$("#role_edit_form input[id='role_name']").validatebox('isValid')) {
            common_tool.messager_show("请输入角色名称");
        } else if (!$("#role_edit_form input[id='role_description']").validatebox('isValid')) {
            ...
            var name = $("#role_edit_form input[id='role_name']").val();
            var description = $("#role_edit_form input[id='role_description']").val();
    ...
    update: function () {
        if (!$("#role_edit_form input[id='role_name']").validatebox('isValid')) {
            ...
            var id = $("#role_edit_form input[id='role_id']").val();
            var name = $("#role_edit_form input[id='role_name']").val();
            var description = $("#role_edit_form input[id='role_description']").val();
            var permission_array = $("#role_edit_form table[id='role-permissions']").datagrid("getChecked");
            var permission_ids = new Array();
