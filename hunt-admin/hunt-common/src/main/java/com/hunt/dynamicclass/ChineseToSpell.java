...
public class ChineseToSpell {
   ...
   public static List<String> getColumnStr(String strs) {
   	String[] split = strs.split(",");
   	List<String> listColumn=new ArrayList<String>();
   	for(String str:split) {
   		String firstSpell = ChineseToSpell.getFirstSpell(str);
   		listColumn.add(firstSpell);
   	}
   	return listColumn;
   }
   
   public static String getJsonStr(String strs,List<String> listColumn) {
//   	List<String> columnStr = getColumnStr(strs); 
   	String[] split = strs.split(",");
   		StringBuffer sbu = new StringBuffer();
   		sbu.append("{");
   		for(int i=0;i<split.length;i++) {
   			sbu.append("\""+listColumn.get(i)+"\""+":");
   			sbu.append("\""+split[i]+"\"");
   			if(i!=split.length-1) {
   				sbu.append(",");
   			}
